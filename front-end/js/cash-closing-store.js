(function () {
  ...
  function check(error) {
    ...
    if (['PGRST202', 'PGRST205', '42P01', '42883'].includes(error.code)) {
      throw new Error('Ative o fechamento: execute o arquivo back-end/supabase/06-fechamento-caixa.sql no SQL Editor do Supabase e clique em Atualizar conferência.');
    }
