...
begin
  ...
  start_at := p_date::timestamp at time zone 'America/Sao_Paulo';
  end_at := (p_date + 1)::timestamp at time zone 'America/Sao_Paulo';
  ...
  return jsonb_build_object('date', p_date, 'timeZone', 'America/Sao_Paulo', 'orders', day_orders,
